...
public enum Station {
    ...
    BOMUN("보문역", "BOMUN", 37.585398, 127.019369),
    APGUJEONRODEO("압구정로데오역", "APGUJEONRODEO", 37.527403, 127.040574),
    BANGI("방이역", "BANGI", 37.508572, 127.125971),
    HONGIKUNIV("홍대입구역", "HONGIKUNIV", 37.557299, 126.924310),
    AHYEON("아현역", "AHYEON", 37.557402, 126.956086),
    ;
