...
public enum StoreErrorCode implements ErrorCode {
    ...
    STORE_KAKAO_LINK_NOT_FOUND(HttpStatus.NOT_FOUND, 40405, "스토어의 카카오링크를 찾을 수 없습니다."),
    STORE_OPERATION_TIME_NOT_FOUND(HttpStatus.NOT_FOUND, 40406, "스토어의 운영시간을 찾을 수 없습니다."),
    STORE_MAIN_IMAGE_NOT_FOUND(HttpStatus.NOT_FOUND, 40407, "스토어의 메인이미지를 찾을 수 없습니다."),
